...
<div class="container mx-auto mt-[5.5rem]">
    {#each credentials as { website, password, email, persona_note, category }}
    <div class="mx-auto">
                    ...
                    <tr>
                        ...
                        <td class="text-[#34495E] text-opacity-60 pr-6 py-4 whitespace-nowrap text-md">
                            <div class="flex flex-row items-center">
                                <input disabled type="password" value={".".repeat(password.length || "......")} class="text-primary bg-transparent outline-none ring-0 text-lg rounded-md w-24">
